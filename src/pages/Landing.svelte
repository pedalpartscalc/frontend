...
<html lang="en">
  ...
  <body>
    <section>
      ...
      <div class="hidden sm:block">
        <div class="pb-12 bg-white dark:bg-background_dark sm:pb-16">
          <div class="relative">
            <div
              class="absolute inset-0 h-1/2 bg-code dark:bg-background_dark"
            />
                    ...
                    <div class="flex">
                      ...
                      <div class="ml-4">
                        ...
                        <p
                          ...
                          "
                        >
                          Stay in the loop on your car's gas mileage and see
                          graphs of its stats.
                        </p>
                      </div>
                    </div>
      ...
      <div class="bg-white dark:bg-background_dark mx-4">
        ...
        >
          <h2
            ...
            "
          >
            Start keeping track of your car
          </h2>
          <p
            class="mt-4 max-w-2xl sm:text-lg leading-7 text-gray-100 lg:mx-auto"
          >
            Create a <span class="font-bold tracking-wide">free</span> account and
          ...
          <svg
            class="absolute inset-0 h-full w-full rounded-b-lg pointer-events-none"
    ...
    <section id="footer">
      <div class="bg-white dark:bg-background_dark">
        <div
          class="
            max-w-screen-xl
            mx-auto
